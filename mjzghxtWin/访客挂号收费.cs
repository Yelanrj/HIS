...
{
    public partial class 访客挂号收费 : Form
    {
        string 收费员;
        public int 就诊卡号;
        bool 急诊挂号;

        public 访客挂号收费(int 就诊卡号,bool 急诊挂号)
        {
            InitializeComponent();
            this.收费员 = "自主缴费";
            this.急诊挂号 = 急诊挂号;
        ...
        {   
            ...
            string sql = "select 病人.*,挂号.挂号日期,挂号.挂号序号,挂号.就诊卡号,挂号.挂号科室,挂号.挂号医生," +
                ...
                " and 挂号.是否收费=0 and 挂号.是否退号=0 and 挂号.就诊卡号="+就诊卡号.ToString();
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            //询问用户是否收费
            DialogResult dr = MessageBox.Show("确认缴费？ ", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            if (是否退号)
            {
                MessageBox.Show("该病人的挂号已退号，无法缴费");
                return;
            }
            //需要使用事务
