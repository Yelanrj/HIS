...
{
    public partial class 访客挂号缴费查询 : Form
    {
        bool 急诊挂号;
        int 就诊卡号;
        public 访客挂号缴费查询(int 就诊卡号,bool 急诊挂号)
        {
            InitializeComponent();
            this.就诊卡号 = 就诊卡号;
            this.急诊挂号 = 急诊挂号;
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            string sql = "select 病人.*,挂号.挂号日期,挂号.挂号序号,挂号.就诊卡号,挂号.挂号科室,挂号.挂号医生," +
                "挂号.号别,挂号.挂号费,挂号.是否收费,挂号.是否退号 from 病人,挂号 where 病人.门诊号=挂号.门诊号 and 就诊卡号="+就诊卡号.ToString();
